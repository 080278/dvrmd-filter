...
/////////////////////////////////////////////////////////////////////////////
// CDvrmvplayerctrl1 wrapper class

class CDvrmvplayerctrl1 : public CWnd
{
protected:
	DECLARE_DYNCREATE(CDvrmvplayerctrl1)
public:
...
//
	...
	void CapPic(BSTR * pCapPicPath)
	{
		static BYTE parms[] = VTS_PBSTR ;
		InvokeHelper(0x12, DISPATCH_METHOD, VT_EMPTY, NULL, parms, pCapPicPath);
	}
	void GetCapturePath(BSTR * pbstrCapFolder)
	{
		static BYTE parms[] = VTS_PBSTR ;
		InvokeHelper(0x13, DISPATCH_METHOD, VT_EMPTY, NULL, parms, pbstrCapFolder);
	}
