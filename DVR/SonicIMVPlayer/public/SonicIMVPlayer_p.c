...
#define PROC_FORMAT_STRING_SIZE   1589                              
#define EXPR_FORMAT_STRING_SIZE   1                                 
#define TRANSMIT_AS_TABLE_SIZE    0            
#define WIRE_MARSHAL_TABLE_SIZE   1            

typedef struct _SonicIMVPlayer_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } SonicIMVPlayer_MIDL_TYPE_FORMAT_STRING;

typedef struct _SonicIMVPlayer_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } SonicIMVPlayer_MIDL_PROC_FORMAT_STRING;

typedef struct _SonicIMVPlayer_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } SonicIMVPlayer_MIDL_EXPR_FORMAT_STRING;
...
extern const SonicIMVPlayer_MIDL_TYPE_FORMAT_STRING SonicIMVPlayer__MIDL_TypeFormatString;
extern const SonicIMVPlayer_MIDL_PROC_FORMAT_STRING SonicIMVPlayer__MIDL_ProcFormatString;
extern const SonicIMVPlayer_MIDL_EXPR_FORMAT_STRING SonicIMVPlayer__MIDL_ExprFormatString;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO ISonicIMVControls_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO ISonicIMVControls_ProxyInfo;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO ISonicIMVSettings_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO ISonicIMVSettings_ProxyInfo;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO ISonicIMVMedia_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO ISonicIMVMedia_ProxyInfo;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO ISonicIMVPlayer_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO ISonicIMVPlayer_ProxyInfo;
...
static const SonicIMVPlayer_MIDL_PROC_FORMAT_STRING SonicIMVPlayer__MIDL_ProcFormatString =
    {
        0,
        {
...
/* 1342 */	NdrFcShort( 0x27 ),	/* 39 */
/* 1344 */	NdrFcShort( 0x8 ),	/* x86 Stack size/offset = 8 */
...
/* 1378 */	NdrFcShort( 0x30 ),	/* Type Offset=48 */
...
/* 1412 */	NdrFcShort( 0x22 ),	/* Type Offset=34 */
...
/* 1432 */	NdrFcShort( 0x2a ),	/* 42 */
/* 1434 */	NdrFcShort( 0xc ),	/* x86 Stack size/offset = 12 */
...
/* 1490 */	0x5,		/* Oi2 Flags:  srv must size, has return, */
			0x2,		/* 2 */
...
/* 1496 */	NdrFcShort( 0x22 ),	/* Type Offset=34 */
...
/* 1520 */	NdrFcShort( 0x2113 ),	/* Flags:  must size, must free, out, simple ref, srv alloc size=8 */
/* 1522 */	NdrFcShort( 0x4 ),	/* x86 Stack size/offset = 4 */
/* 1524 */	NdrFcShort( 0x22 ),	/* Type Offset=34 */
...
static const SonicIMVPlayer_MIDL_TYPE_FORMAT_STRING SonicIMVPlayer__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Standard interface: __MIDL_itf_SonicIMVPlayer_0000_0000, ver. 0.0,
...
/* Object interface: ISonicIMVControls, ver. 0.0,
   GUID={0x583C0343,0x05D2,0x4c3a,{0x92,0x82,0xFC,0x14,0xC8,0x39,0x6E,0x4E}} */

#pragma code_seg(".orpc")
static const unsigned short ISonicIMVControls_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO ISonicIMVControls_ProxyInfo =
    {
    &Object_StubDesc,
    SonicIMVPlayer__MIDL_ProcFormatString.Format,
    &ISonicIMVControls_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO ISonicIMVControls_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    SonicIMVPlayer__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(16) _ISonicIMVControlsProxyVtbl = 
{
    &ISonicIMVControls_ProxyInfo,
    &IID_ISonicIMVControls,
    ...
    (void *) (INT_PTR) -1 /* ISonicIMVControls::play */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVControls::stop */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVControls::pause */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVControls::fastForward */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVControls::fastReverse */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVControls::get_currentPosition */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVControls::put_currentPosition */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVControls::get_currentPositionString */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVControls::get_isAvailable */
};


static const PRPC_STUB_FUNCTION ISonicIMVControls_table[] =
{
...
CInterfaceStubVtbl _ISonicIMVControlsStubVtbl =
{
    &IID_ISonicIMVControls,
    &ISonicIMVControls_ServerInfo,
    16,
    &ISonicIMVControls_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};


/* Object interface: ISonicIMVSettings, ver. 0.0,
   GUID={0x7D45535F,0x3ECE,0x4bd7,{0xA8,0x68,0xC1,0xB2,0xA8,0x12,0x8A,0x76}} */

#pragma code_seg(".orpc")
static const unsigned short ISonicIMVSettings_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO ISonicIMVSettings_ProxyInfo =
    {
    &Object_StubDesc,
    SonicIMVPlayer__MIDL_ProcFormatString.Format,
    &ISonicIMVSettings_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO ISonicIMVSettings_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    SonicIMVPlayer__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(11) _ISonicIMVSettingsProxyVtbl = 
{
    &ISonicIMVSettings_ProxyInfo,
    &IID_ISonicIMVSettings,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    0 /* IDispatch::GetTypeInfoCount */ ,
    ...
    0 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVSettings::get_mute */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVSettings::put_mute */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVSettings::get_volume */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVSettings::put_volume */
};


static const PRPC_STUB_FUNCTION ISonicIMVSettings_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _ISonicIMVSettingsStubVtbl =
{
    &IID_ISonicIMVSettings,
    &ISonicIMVSettings_ServerInfo,
    11,
    &ISonicIMVSettings_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};


/* Object interface: ISonicIMVMedia, ver. 0.0,
   GUID={0x842D4D89,0xDB49,0x43d9,{0x8A,0xA6,0x44,0xD4,0x48,0x3F,0xBF,0xC3}} */

#pragma code_seg(".orpc")
static const unsigned short ISonicIMVMedia_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO ISonicIMVMedia_ProxyInfo =
    {
    &Object_StubDesc,
    SonicIMVPlayer__MIDL_ProcFormatString.Format,
    &ISonicIMVMedia_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO ISonicIMVMedia_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    SonicIMVPlayer__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(11) _ISonicIMVMediaProxyVtbl = 
{
    &ISonicIMVMedia_ProxyInfo,
    &IID_ISonicIMVMedia,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    ...
    0 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVMedia::get_imageSourceWidth */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVMedia::get_imageSourceHeight */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVMedia::get_duration */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVMedia::get_durationString */
};


static const PRPC_STUB_FUNCTION ISonicIMVMedia_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _ISonicIMVMediaStubVtbl =
{
    &IID_ISonicIMVMedia,
    &ISonicIMVMedia_ServerInfo,
    11,
    &ISonicIMVMedia_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};


/* Object interface: ISonicIMVPlayer, ver. 0.0,
   GUID={0x1EF48C0B,0x67B9,0x489D,{0x92,0xF4,0x0C,0x14,0x53,0xF6,0x13,0xE8}} */

#pragma code_seg(".orpc")
static const unsigned short ISonicIMVPlayer_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO ISonicIMVPlayer_ProxyInfo =
    {
    &Object_StubDesc,
    SonicIMVPlayer__MIDL_ProcFormatString.Format,
    &ISonicIMVPlayer_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO ISonicIMVPlayer_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    SonicIMVPlayer__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(48) _ISonicIMVPlayerProxyVtbl = 
{
    &ISonicIMVPlayer_ProxyInfo,
    &IID_ISonicIMVPlayer,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    ...
    0 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::get_URL */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::put_URL */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::get_fullScreen */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::put_fullScreen */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::get_uiMode */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::put_uiMode */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::get_status */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::get_playState */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::get_versionInfo */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::close */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::get_controls */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::play */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::stop */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::pause */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::fastForward */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::fastReverse */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::get_currentPosition */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::put_currentPosition */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::get_currentPositionString */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::get_isAvailable */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::get_settings */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::get_mute */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::put_mute */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::get_volume */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::put_volume */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::get_currentMedia */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::get_imageSourceWidth */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::get_imageSourceHeight */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::get_duration */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::get_durationString */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::OpenFile */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::Login */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::Logout */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::SetMediaServer */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::GetMediaServer */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::StartMonitor */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::StopMonitor */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::CapPic */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::GetCapturePath */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::SetCapturePath */ ,
    (void *) (INT_PTR) -1 /* ISonicIMVPlayer::ShowMetaData */
};


static const PRPC_STUB_FUNCTION ISonicIMVPlayer_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _ISonicIMVPlayerStubVtbl =
{
    &IID_ISonicIMVPlayer,
    &ISonicIMVPlayer_ServerInfo,
    48,
    &ISonicIMVPlayer_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    SonicIMVPlayer__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _SonicIMVPlayer_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_ISonicIMVPlayerProxyVtbl,
    ( CInterfaceProxyVtbl *) &_ISonicIMVControlsProxyVtbl,
    ( CInterfaceProxyVtbl *) &_ISonicIMVSettingsProxyVtbl,
    ( CInterfaceProxyVtbl *) &_ISonicIMVMediaProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _SonicIMVPlayer_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_ISonicIMVPlayerStubVtbl,
    ( CInterfaceStubVtbl *) &_ISonicIMVControlsStubVtbl,
    ( CInterfaceStubVtbl *) &_ISonicIMVSettingsStubVtbl,
...
PCInterfaceName const _SonicIMVPlayer_InterfaceNamesList[] = 
{
    "ISonicIMVPlayer",
    "ISonicIMVControls",
    "ISonicIMVSettings",
...
const IID *  const _SonicIMVPlayer_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    &IID_IDispatch,
...
#define _SonicIMVPlayer_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _SonicIMVPlayer, pIID, n)

int __stdcall _SonicIMVPlayer_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _SonicIMVPlayer, 4, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _SonicIMVPlayer, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _SonicIMVPlayer, 4, *pIndex )
    
}

const ExtendedProxyFileInfo SonicIMVPlayer_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _SonicIMVPlayer_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _SonicIMVPlayer_StubVtblList,
    (const PCInterfaceName * ) & _SonicIMVPlayer_InterfaceNamesList,
    (const IID ** ) & _SonicIMVPlayer_BaseIIDList,
    & _SonicIMVPlayer_IID_Lookup, 
    4,
    2,
