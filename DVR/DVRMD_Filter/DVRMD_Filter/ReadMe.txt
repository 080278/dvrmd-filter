========================================================================
    ACTIVEX CONTROL DLL : DVRMD_Filter Project Overview
========================================================================

ControlWizard has created this project for your DVRMD_Filter ActiveX Control
...
that make up your DVRMD_Filter ActiveX Control DLL.
...
DVRMD_Filter.ico
    ...
    is included by the main resource file DVRMD_Filter.rc.

/////////////////////////////////////////////////////////////////////////////
CDVRMD_FilterCtrl control:

DVRMD_FilterCtrl.h
    This file contains the declaration of the CDVRMD_FilterCtrl C++ class.

DVRMD_FilterCtrl.cpp
    This file contains the implementation of the CDVRMD_FilterCtrl C++ class.

DVRMD_FilterPropPage.h
    This file contains the declaration of the CDVRMD_FilterPropPage C++ class.

DVRMD_FilterPropPage.cpp
    This file contains the implementation of the CDVRMD_FilterPropPage C++ class.

CDVRMD_FilterCtrl.bmp
    This file contains a bitmap that a container will use to represent the
    CDVRMD_FilterCtrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file DVRMD_Filter.rc.
...
stdafx.h, stdafx.cpp
    ...
    named DVRMD_Filter.pch and a precompiled types (PCT) file named stdafx.obj.
