...
// DVRMDFrameDlg.cpp : implementation file
//
...
CDVRMDFrameDlg::CDVRMDFrameDlg(CWnd* pParent /*=NULL*/)
	: CDialog(CDVRMDFrameDlg::IDD, pParent)
{
...
// CDVRMDFrameDlg message handlers

BOOL CDVRMDFrameDlg::OnInitDialog()
{
...
void CDVRMDFrameDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
HCURSOR CDVRMDFrameDlg::OnQueryDragIcon()
{
