...
void CTabSheet::SetRect()
{
	...
	m_pPages[0]->SetWindowPos(&wndTop, nX, 2*nY, nXc, 2*nYc, SWP_SHOWWINDOW);
	for( int nCount=1; nCount < m_nNumOfPages; nCount++ )
		m_pPages[nCount]->SetWindowPos(&wndTop, nX, 2*nY, nXc, nYc, SWP_HIDEWINDOW);
