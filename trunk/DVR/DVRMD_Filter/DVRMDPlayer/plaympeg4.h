...
//Timer type
#define TIMER_0 0 //只能在实时流模式下追求最小延时时使用
#define TIMER_1 1 //Only 16 timers for every process.Default TIMER;
#define TIMER_2 2 //Not limit;But the precision less than TIMER_1; 

#define PLAY_BYFRAMERATE 0 
#define PLAY_BYFRAMETIME 1 
...
PLAYM4_API BOOL __stdcall PlayM4_SetDisplayMode(LONG nPort, DWORD dwType);
PLAYM4_API BOOL __stdcall PlayM4_SetDecryptCallBack(LONG nPort, char* strKey, LONG lKeyLen, void (CALLBACK* DecryptCB)(LONG nPort, BYTE* pData, DWORD dwDataLen, DWORD dwUser), DWORD dwUser);

PLAYM4_API BOOL __stdcall PlayM4_RegisterIVSDrawFunCB(LONG nPort, void (CALLBACK* IVSDrawFun)(LONG nPort, HDC hDC, FRAME_INFO* pFrameInfo, SYNCDATA_INFO* pSyncData, DWORD dwUser), DWORD dwUser);
#endif //_PLAYM4_H_